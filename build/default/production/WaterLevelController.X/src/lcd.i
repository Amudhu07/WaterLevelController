# 1 "WaterLevelController.X/src/lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "WaterLevelController.X/src/lcd.c" 2
...
# 2 "WaterLevelController.X/src/lcd.c" 2
...
# 3 "WaterLevelController.X/src/lcd.c" 2
...
void lcd_clear(void);
# 4 "WaterLevelController.X/src/lcd.c" 2
# 20 "WaterLevelController.X/src/lcd.c"
void lcd_delay_us(unsigned int us) {
    while(us--) _delay((unsigned long)((1)*(8000000/4000000.0)));
}

void lcd_delay_ms(unsigned int ms) {
    while(ms--) _delay((unsigned long)((1)*(8000000/4000.0)));
}

void lcd_send_nibble(unsigned char nibble) {
    LATBbits.LATB5 = (nibble >> 0) & 1;
    LATBbits.LATB4 = (nibble >> 1) & 1;
    LATBbits.LATB3 = (nibble >> 2) & 1;
    LATBbits.LATB2 = (nibble >> 3) & 1;
...
void lcd_init(void) {
    TRISBbits.TRISB1 = 0; TRISBbits.TRISB0 = 0;
    TRISBbits.TRISB5 = 0; TRISBbits.TRISB4 = 0;
    TRISBbits.TRISB3 = 0; TRISBbits.TRISB2 = 0;

    LATBbits.LATB1 = 0; LATBbits.LATB0 = 0;
    lcd_delay_ms(50);
