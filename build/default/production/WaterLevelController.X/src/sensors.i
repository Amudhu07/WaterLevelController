# 1 "WaterLevelController.X/src/sensors.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "WaterLevelController.X/src/sensors.c" 2
...
# 5 "WaterLevelController.X/src/sensors.h" 2
...
# 2 "WaterLevelController.X/src/sensors.c" 2
...
# 3 "WaterLevelController.X/src/sensors.c" 2
...
void update_sensor_values(void) {
    low_val = read_adc_voltage(7);
    high_val = read_adc_voltage(6);
    dry_val = read_adc_voltage(5);
}
