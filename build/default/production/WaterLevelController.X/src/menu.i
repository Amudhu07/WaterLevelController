# 1 "WaterLevelController.X/src/menu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "WaterLevelController.X/src/menu.c" 2
...
# 2 "WaterLevelController.X/src/menu.c" 2
...
void lcd_clear(void);
# 3 "WaterLevelController.X/src/menu.c" 2
...
# 4 "WaterLevelController.X/src/menu.c" 2
# 1 "WaterLevelController.X/src/eeprom_utils.h" 1
...
# 5 "WaterLevelController.X/src/menu.c" 2
...
void menu_config(void) {
    ...
    int high_voltage = read_eeprom(0x10);
    int low_voltage = read_eeprom(0x14);
    int trip_current = read_eeprom(0x18);
    ...
    write_eeprom(0x10, high_voltage);
    write_eeprom(0x14, low_voltage);
    write_eeprom(0x18, trip_current);
}
