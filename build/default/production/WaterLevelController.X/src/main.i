# 1 "WaterLevelController.X/src/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "WaterLevelController.X/src/main.c" 2
...
# 2 "WaterLevelController.X/src/main.c" 2
# 1 "WaterLevelController.X/src/adc.h" 1
...
# 3 "WaterLevelController.X/src/main.c" 2
# 1 "WaterLevelController.X/src/sensors.h" 1




# 1 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include\\c99/stdbool.h" 1 3
# 6 "WaterLevelController.X/src/sensors.h" 2

void update_sensor_values(void);
_Bool is_low_level(void);
_Bool is_high_level(void);
_Bool is_dry_run_triggered(void);
# 4 "WaterLevelController.X/src/main.c" 2
# 1 "WaterLevelController.X/src/motor_control.h" 1
...
_Bool is_motor_running(void);
# 5 "WaterLevelController.X/src/main.c" 2
# 1 "WaterLevelController.X/src/lcd.h" 1
...
# 4 "WaterLevelController.X/src/lcd.h" 2
void lcd_init(void);
void lcd_putc(char c);
void lcd_puts(const char *str);
void lcd_gotoxy(unsigned char x, unsigned char y);
void lcd_clear(void);
# 6 "WaterLevelController.X/src/main.c" 2
