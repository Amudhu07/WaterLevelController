# 1 "WaterLevelController.X/src/motor_control.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "WaterLevelController.X/src/motor_control.c" 2
...
# 5 "WaterLevelController.X/src/motor_control.h" 2

# 1 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include\\c99/stdbool.h" 1 3
# 7 "WaterLevelController.X/src/motor_control.h" 2
...
# 2 "WaterLevelController.X/src/motor_control.c" 2
...
static _Bool motor_state = 0;
# 17 "WaterLevelController.X/src/motor_control.c"
void init_motor(void) {
